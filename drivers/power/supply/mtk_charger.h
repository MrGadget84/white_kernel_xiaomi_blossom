...
#define USB_CHARGER_CURRENT_CONFIGURED		3200000 /* 3200mA */
#define USB_CHARGER_CURRENT			3200000 /* 3200mA */
#define AC_CHARGER_CURRENT			3500000
#define AC_CHARGER_INPUT_CURRENT		3500000
#define NON_STD_AC_CHARGER_CURRENT		3200000
